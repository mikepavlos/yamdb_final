...
База информации и отзывов о произведениях искусства таких категорий, 
как «Книги», «Фильмы», «Музыка». 
Список категорий может быть расширен администратором. 
Сервис API Yamdb предоставляет возможность:
...
Создать файл `.env`, заполнить его по образцу:
...
2. #### Путем разворачивания образа из DockerHub:

Если проект не склонирован с GitHub, создать папку infra, в ней создать файлы:
